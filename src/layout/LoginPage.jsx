...
import BLADERUNNER from '../BLADELOGIN.jpeg'
  ...
  return (
    ...
    <Container>
        ...
        <Holder2>
            ...
            <LoginText style={{fontSize:'16px'}} >Glad to see you back.!</LoginText>
            <LoginForm action="" onSubmit={(e)=>{handlesubmit(e)}}>     
                ...
                <a style={{textDecoration:'none', color:'white'}} href="url">Forgot password ?</a>
